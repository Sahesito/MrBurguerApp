package com.sahe.mrburguerapp.Activity.Extra;
...
//a clase TinyDB es un wrapper diseñada para simplificar el proceso de
// guardar y recuperar datos de forma persistente en una aplicación de Android.
public class TinyDB {
